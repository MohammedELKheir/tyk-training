---
id: foundation-tyk-architecture-1-traffic-routing/007-api-request-flow-6
...
requires_context: []
builds_on: []
recommended_next: [foundation-tyk-architecture-1-traffic-routing/008-api-request-flow-7]
