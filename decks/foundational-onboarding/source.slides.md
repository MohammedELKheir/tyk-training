...
<img src="./images/icons/check-icon.png" style="width:40px; height:40px; margin-top:0.3rem;" />
</div>
</div>
</div>
...
<img src="./images/icons/tyk-logo.png" style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); width:28px; height:28px; background:#fff; border-radius:4px; padding:2px;" />
</div>
...
<img src="./images/icons/oas-servers-config.png" style="max-width:34%; max-height:150px; object-fit:contain;" />
<div style="width:56px; height:24px; background:#8438FA; clip-path:polygon(0 0, 70% 0, 100% 50%, 70% 100%, 0 100%);"></div>
<img src="./images/icons/oas-servers-detail.png" style="max-width:42%; max-height:180px; object-fit:contain;" />
</div>
...
<img src="./images/icons/validation-bar.png" style="width:82%; max-height:72px; object-fit:contain;" />
</div>

<div style="display:flex; gap:1rem; margin-top:0.25rem; align-items:center; justify-content:center;">
<img src="./images/icons/validation-diagram.png" style="max-width:40%; max-height:210px; object-fit:contain;" />
<img src="./images/icons/validation-schema.png" style="max-width:42%; max-height:220px; object-fit:contain;" />
</div>
...
<img src="./images/icons/middleware-flow.png" style="max-width:40%; max-height:210px; object-fit:contain;" />
<img src="./images/icons/middleware-detail.png" style="max-width:42%; max-height:220px; object-fit:contain;" />
</div>
...
<div style="text-align: center; margin-top: 1rem;">
  <img src="./images/icons/jwt-anatomy.png" style="width: 100%; max-height: 400px; object-fit: contain;" />
</div>
...
<div style="display: flex; gap: 2rem; margin-top: 1rem;">
  <div style="flex: 3;">
    <img src="./images/icons/jwt-config-diagram.png" style="width: 100%; max-height: 400px; object-fit: contain;" />
  </div>
...
<div style="text-align: center; margin-top: 1rem;">
  <img src="./images/icons/jwt-flow-diagram.png" style="width: 100%; max-height: 420px; object-fit: contain;" />
</div>
...
<div style="text-align: center; margin-top: 1rem;">
  <img src="./images/icons/throttling-diagram.png" style="width: 100%; max-height: 420px; object-fit: contain;" />
</div>
...
<div style="text-align: center; margin-top: 1rem;">
  <img src="./images/icons/quota-example.png" style="width: 100%; max-height: 420px; object-fit: contain;" />
</div>
...
<div style="display:flex; justify-content:center; margin-top:2.5rem;">
  <div style="display:flex; align-items:flex-end; justify-content:center; gap:2.6rem;">
    <div style="display:flex; flex-direction:column; align-items:center;">
      <img src="./images/icons/gateway-icon.png" style="width:72px; height:72px;" />
    ...
    <div style="display:flex; flex-direction:column; align-items:center; background:#f3f3f3; border:1px solid #bbb; border-radius:18px; padding:14px 20px; min-width:110px;">
      ...
      <img src="./images/icons/redis-icon.png" style="width:58px; height:58px;" />
      <div style="height:26px;"></div>
      <img src="./images/icons/client-icon.png" style="width:62px; height:62px;" />
      <div style="font-size:14px; margin-top:6px; color:#333;">Gateway</div>
    </div>
    <div style="display:flex; flex-direction:column; align-items:center;">
      <img src="./images/icons/server-icon.png" style="width:72px; height:72px;" />
...
<div style="display:flex; justify-content:center; margin-top:2.3rem;">
  <div style="display:flex; align-items:flex-end; justify-content:center; gap:2.6rem;">
    ...
    <div style="display:flex; flex-direction:column; align-items:center; background:#f3f3f3; border:1px solid #bbb; border-radius:18px; padding:14px 20px 12px 20px; min-width:110px;">
      ...
      <img src="./images/icons/client-icon.png" style="width:62px; height:62px;" />
      <div style="font-size:14px; margin-top:6px; color:#333;">Gateway</div>
      <img src="./images/icons/slide47_Google_Shape;606;p74.png" style="width:40px; height:40px; margin-top:10px;" />
    </div>
    <div style="display:flex; flex-direction:column; align-items:center;">
      <img src="./images/icons/server-icon.png" style="width:72px; height:72px;" />
      <div style="font-size:14px; margin-top:6px; color:#333;">Server</div>
...
<div style="display:flex; justify-content:center; margin-top:2.3rem;">
  <div style="display:flex; align-items:flex-start; gap:1rem;">
    <div style="display:flex; flex-direction:column; align-items:center; margin-top:6px;">
      ...
      <img src="./images/icons/redis-icon.png" style="width:72px; height:72px;" />
    </div>
    ...
    <div style="display:flex; flex-direction:column; align-items:center; margin-top:6px;">
      ...
      <img src="./images/icons/pump-icon.png" style="width:78px; height:78px;" />
    </div>
    <div style="display:flex; align-items:center; margin-top:38px; gap:6px;">
      <div style="width:42px; height:2px; background:#666;"></div>
      <div style="width:0; height:0; border-top:6px solid transparent; border-bottom:6px solid transparent; border-left:10px solid #666;"></div>
    ...
    <div style="display:flex; flex-direction:column; align-items:center; margin-top:6px;">
      ...
      <img src="./images/icons/database-icon.png" style="width:76px; height:76px;" />
      ...
      <img src="./images/icons/gateway-icon.png" style="width:68px; height:68px; margin-top:8px;" />
...
<div style="text-align: center; margin-top: 2rem;">
  <img src="./images/icons/timeout-diagram.png" alt="Enforced Timeout Diagram" style="max-width: 600px; width: 100%;" />
</div>
...
<div style="display:flex; align-items:center; margin-bottom:1.5rem;">
  <img src="./images/icons/sla-badge.png" style="height:28px; margin-right:10px;" />
