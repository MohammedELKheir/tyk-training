<template>
  <div style="position: relative; width: 520px; height: 430px;">
    <svg viewBox="0 0 520 430" style="position:absolute; inset:0; width:100%; height:100%; overflow:visible;">
      <defs>
        <marker id="arrow-head" markerWidth="10" markerHeight="8" refX="8" refY="4" orient="auto" markerUnits="strokeWidth">
    ...
    <div style="position:absolute; left:150px; top:28px; width:170px; height:330px; border:2px solid #707070; border-radius:34px; background:#f3f3f3;">
      ...
      <svg v-if="gatewayToRedis" viewBox="0 0 170 330" style="position:absolute; inset:0; width:100%; height:100%; overflow:visible;">
        <line x1="85" y1="204" x2="85" y2="140" stroke="#6a6a6a" stroke-width="2" marker-end="url(#arrow-up-inner)" />
        <defs>
          <marker id="arrow-up-inner" markerWidth="10" markerHeight="8" refX="5" refY="4" orient="auto" markerUnits="strokeWidth">
            <path d="M0,8 L5,0 L10,8 z" fill="#6a6a6a" />
          </marker>
        </defs>
      </svg>

      <div v-if="showGear" style="position:absolute; left:50%; bottom:10px; transform:translateX(-50%); width:54px; height:54px;">
