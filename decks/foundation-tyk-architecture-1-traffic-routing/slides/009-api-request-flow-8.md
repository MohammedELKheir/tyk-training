---
id: foundation-tyk-architecture-1-traffic-routing/009-api-request-flow-8
...
requires_context: []
builds_on: []
recommended_next: [foundation-tyk-architecture-1-traffic-routing/010-traffic-routing-example]
